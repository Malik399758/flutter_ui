...
import 'package:smit_ui_widget/ui_task/english_talk_app/past_video_call.dart';
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
               SizedBox(height: 35,),
               Text('English TalkE',style: TextStyle(fontSize: 19,fontWeight: FontWeight.w900),),
               SizedBox(height: 20,),
               Row(
                 children: [
                   Text(
              ...
              SizedBox(height: 20,),
              isActive ? Upcoming() : PastVideoCall(),
            ],
          ),
        ),
      ),
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Row(
          children: [
            Text('Tomorrow, Jan 12 2025',style: TextStyle(
        ...
        Row(
          children: [
            Text('Today, Jan 11 2025',style: TextStyle(
                color: Colors.grey.shade600,fontSize: 16
            ),),
          ],
        ),
